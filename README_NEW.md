...
- **Auto-Discovery**: Point Reality Router at your local Ollama instance or provide a Gemini API key; it will automatically discover, benchmark, and price every available model.
